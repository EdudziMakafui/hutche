<?php include("includes/header.php");?>
   ...
   <?php include("includes/mini_cart.php");?>
    ...
    <section class="hero_about_section d-flex align-items-center" data-bgimg="assets/img/bg/about-hero.png">
        <div class="container">
            <div class="row">
                <div class="col-12">
                ...
                <div class="col-12">
                    <div class="about_luxury_inner d-flex align-items-center">
                        <div class="about_luxury_thumb">
                            <img src="assets/img/bg/about1.png" alt="">
                        </div>
                ...
                <div class="col-12">
                    <div class="about_vision_inner d-flex align-items-center">
                        ...
                        <div class="about_vision_thumb">
                            <img src="assets/img/bg/about2.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="our_team_inner d-flex justify-content-center">
                        <div class="single_team wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1.1s">
                            <div class="team_thumb">
                                <img src="assets/img/others/team1.png" alt="">
                            </div>
                            <div class="team_name">
                        ...
                        <div class="single_team wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1.2s">
                            <div class="team_thumb">
                                <img src="assets/img/others/team2.png" alt="">
                            </div>
                            <div class="team_name">
                        ...
                        <div class="single_team wow fadeInUp" data-wow-delay="0.3s" data-wow-duration="1.3s">
                            <div class="team_thumb">
                                <img src="assets/img/others/team3.png" alt="">
                            </div>
                            <div class="team_name">
                        ...
                        <div class="single_team wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1.4s">
                            <div class="team_thumb">
                                <img src="assets/img/others/team4.png" alt="">
                            </div>
                            <div class="team_name">
